...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 318.0, 35.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					"annotation" : "feedbackdelay(raw)",
					"comment" : "feedbackdelay(raw)",
					"hint" : "feedbackdelay(raw)",
					"id" : "obj-17",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					...
					"style" : "",
					"varname" : "feedbackdelay(raw)"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "feedbackdelay(lin 0.-1.)",
					"comment" : "feedbackdelay(lin 0.-1.)",
					"hint" : "feedbackdelay(lin 0.-1.)",
					"id" : "obj-16",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					...
					"style" : "",
					"varname" : "feedbackdelay(lin"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "feedbackdepth(0.-1000.)",
					"comment" : "feedbackdepth(0.-1000.)",
					"hint" : "feedbackdepth(0.-1000.)",
					"id" : "obj-15",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
					...
					"style" : "",
					"varname" : "feedbackdepth(0-1000)"
				}

			}
, 			{
				"box" : 				{
					"annotation" : "feedbackdepth(rawsig)",
					"comment" : "feedbackdepth(rawsig)",
					"hint" : "feedbackdepth(rawsig)",
					"id" : "obj-5",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 397.0, 169.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "pow 1.6"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 221.0, 55.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -3.0, 246.0, 84.0, 26.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 221.0, 55.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 187.5, 246.0, 84.0, 26.0 ],
					"style" : "",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 396.0, 251.0, 197.0, 24.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ 187.5, 282.0, 84.0, 60.0 ],
					"style" : "",
					"text" : "FM Feedback DelayTime",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 396.0, 188.0, 112.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 396.0, 124.0, 40.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 196.0, 188.0, 67.0, 67.0 ],
					"size" : 1.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 265.0, 101.0, 197.0, 24.0 ],
					"presentation" : 1,
					"presentation_linecount" : 3,
					"presentation_rect" : [ -1.5, 277.5, 84.0, 60.0 ],
					"style" : "",
					"text" : "FM Feedback Depth",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 318.0, 124.0, 40.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 188.0, 67.0, 67.0 ],
					"size" : 1000.0,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 318.0, 169.0, 33.0, 22.0 ],
					"style" : "",
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 169.0, 61.0, 22.0 ],
					"style" : "",
					"text" : "tapout~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 145.0, 84.0, 22.0 ],
					"style" : "",
					"text" : "tapin~ 20000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 77.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 116.0, 75.0, 120.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 353.0, 339.0, 109.0, 22.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 238.0, 103.0, 41.0, 37.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 116.0, 231.0, 55.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 218.0, 75.0, 197.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 80.0, 101.0, 54.0, 22.0 ],
					"style" : "",
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 116.0, 2.0, 37.0, 22.0 ],
					"style" : "",
					"text" : "lb #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 169.5, 180.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 169.5, 142.0, 65.0, 22.0 ],
					"style" : "",
					"text" : "wave~ Off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 169.5, 103.0, 43.0, 22.0 ],
					"style" : "",
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 353.0, 366.0, 94.0, 22.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-4", 1 ],
					"midpoints" : [ 89.5, 228.0, 24.75, 228.0, 24.75, 66.0, 100.0, 66.0 ],
					"source" : [ "obj-8", 0 ]
				}
