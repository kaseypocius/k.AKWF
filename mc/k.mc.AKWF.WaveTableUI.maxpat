...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 5.5, 90.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 269.0, 2.0, 99.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 267.5, 3.0, 102.0, 24.0 ],
					"text" : "Spread",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 23.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"bordercolor" : [ 1.0, 0.431372549019608, 0.0, 1.0 ],
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 636.0, 62.0, 107.0, 172.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 265.0, 22.0, 107.0, 172.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 636.0, 246.0, 79.0, 22.0 ],
					"text" : "spread $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 5.5, 122.0, 72.0, 22.0 ],
					"text" : "mc.dup~ #2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 91.0, 120.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 360.0, 355.0, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 75.0, 355.0, 256.0, 64.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 22.0, 249.0, 99.0, 42.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 123.0, 247.0, 55.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 225.0, 91.0, 197.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 5.5, 151.0, 156.0, 22.0 ],
					"text" : "mc.phasor~ 1 0 @chans #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 18.0, 37.0, 22.0 ],
					"text" : "lb #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 123.0, 51.0, 30.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 163.5, 215.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 163.5, 166.0, 146.0, 22.0 ],
					"text" : "mc.wave~ Off @chans #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 163.5, 127.0, 43.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 360.0, 382.0, 94.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 485.0, 69.0, 128.0, 128.0 ],
					"presentation" : 1,
