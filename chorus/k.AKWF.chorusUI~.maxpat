...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 10.0, 77.0, 22.0 ],
					"text" : "loadmess #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 122.0, 79.0, 80.0, 22.0 ],
					"text" : "loadmess #1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.0, 442.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 443.5, 251.0, 58.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 214.0, 58.0, 26.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 234.0, 99.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 214.0, 102.0, 24.0 ],
					"text" : "Ratio",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 171.0, 99.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 188.0, 102.0, 24.0 ],
					"text" : "Feedback",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 115.0, 115.0, 58.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 113.0, 188.0, 58.0, 26.0 ],
					"textcolor" : [ 0.952941176470588, 0.564705882352941, 0.098039215686275, 1.0 ],
					"tricolor" : [ 0.501960784313725, 0.501960784313725, 0.501960784313725, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 44.5, 86.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 44.0, 317.0, 98.0, 22.0 ],
					"text" : "k.AKWF.chorus~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 643.0, 337.0, 99.0, 42.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 191.0, 33.0, 102.0, 24.0 ],
					"text" : "WaveTable #",
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 258.0, 285.0, 55.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 191.0, 61.0, 102.0, 26.0 ],
					"textcolor" : [ 0.952941, 0.564706, 0.098039, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 846.0, 149.0, 197.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 7.0, 13.0, 157.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 253.0, 77.0, 22.0 ],
					"text" : "loadmess #3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 520.0, 287.0, 141.0, 22.0 ],
					"text" : "if #3 == 0 then 1. else #1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 472.0, 287.0, 29.5, 22.0 ],
					"text" : "f #2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 205.5, 10.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 436.5, 228.0, 15.0, 15.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 270.0, 361.0, 176.0, 17.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 205.0, 61.0, 120.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 245.5, 149.0, 256.0, 64.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.5, 103.0, 43.0, 22.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1106.0, 157.0, 128.0, 128.0 ],
					"presentation" : 1,
